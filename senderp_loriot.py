...
# get this data from the LoRaWAN Parameters section of the Device part of the Loriot console
send_cmd(ser, b'mac set appkey ___________________________')
send_cmd(ser, b'mac save')
# get this data from the Device Details section of the Device part of the Loriot console
